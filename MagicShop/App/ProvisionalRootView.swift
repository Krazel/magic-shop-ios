        ...
        GeometryReader { geometry in
            ZStack {
                ...
                ShopSceneContainer(
                    ...
                    contentLift: model.panel == .stock ? (geometry.size.height < 700 ? 120 : 180) : ((model.panel == .pricing || model.panel == .care) ? 120 : (model.flow.route == .buildCatalog || model.placementDraft != nil ? 105 : 0)),
